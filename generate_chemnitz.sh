...
"$JAVA" -jar DictionaryBuilder.jar --lang1="DE" --lang2="EN" --dictInfo="tu-chemnitz-based EN-DE" --lang1Stoplist=data/inputs/stoplists/de.txt --input1=data/inputs/chemnitz.txt --input1Name=chemnitz --dictOut=data/outputs/EN-DE_chemnitz.quickdic --input1Charset=UTF8 --input1Format=chemnitz
